...
impl application_framework::Application for Application {
    fn new(device: &wgpu::Device, _queue: &mut wgpu::Queue, surface_configuration: &wgpu::SurfaceConfiguration) -> Self {
        ...
        ui_node_hierarchy.theme_properties = hash_map! {
            ...
            "text_color" => Value::Float4([1.0, 0.9063317, 0.7353569, 1.0].into()),
            "text_selection_color" => Value::Float4([1.0, 1.0, 1.0, 0.5].into()),

            "range_empty_color" => Value::Float4([0.2478005, 0.2478005, 0.2478005, 1.0].into()),
            "range_filled_color" => Value::Float4([0.34919018, 0.5838315, 0.9063317, 1.0].into()),
            "range_corner_radius" => Value::Float1(10.0.into()),

            "button_fill_color" => Value::Float4([0.18974826, 0.18974826, 0.18974826, 1.0].into()),
            "button_corner_radius" => Value::Float1(7.0.into()),
            "button_padding" => Value::Float2([10.0, 10.0].into()),

            "checkbox_unchecked_color" => Value::Float4([0.5838315, 0.5838315, 0.5838315, 1.0].into()),
            "checkbox_checked_color" => Value::Float4([0.34919018, 0.5838315, 0.7353569, 1.0].into()),
            ...
            "dropdown_button_closed_color" => Value::Float4([0.2478005, 0.2478005, 0.2478005, 1.0].into()),
            "dropdown_button_open_color" => Value::Float4([0.4845292, 0.4845292, 0.4845292, 1.0].into()),
            ...
            "speech_balloon_fill_color" => Value::Float4([0.15170372, 0.15170372, 0.15170372, 1.0].into()),
            "speech_balloon_stroke_color" => Value::Float4([0.9063317, 0.9063317, 0.9063317, 1.0].into()),
            ...
            "tab_fill_color" => Value::Float4([0.18974826, 0.18974826, 0.18974826, 1.0].into()),
            "tab_corner_radius" => Value::Float1(7.0.into()),
            "tab_animation_duration" => Value::Float1(0.5.into()),
            "tab_handle_inactive_fill_color" => Value::Float4([0.15170372, 0.15170372, 0.15170372, 1.0].into()),
            "tab_handle_active_fill_color" => Value::Float4([0.7977377, 0.7977377, 0.7977377, 1.0].into()),
            "tab_handle_stroke_color" => Value::Float4([0.9063317, 0.9063317, 0.9063317, 1.0].into()),
